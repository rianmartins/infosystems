$( document ).ready(function() {
    ...
    function blockUI(item) {    
        $(item).block({
            message: '<img src="/static/assets/images/reload.gif" width="20px" alt="">',
            css: {
                border: 'none',
                padding: '0px',
                width: '20px',
    ...
    var fixedHeaderCheck = document.querySelector('.fixed-header-check'),
        ...
        defaultOptions = function() {
            ...
            $(".theme-color").attr("href", '/static/assets/css/themes/white.css');
    ...
    $(".colorbox").click(function(){
        ...
        $(".theme-color").attr('href', '/static/assets/css/themes/' + color + '.css');
        return false;
    });
